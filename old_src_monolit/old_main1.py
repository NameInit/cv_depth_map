...
def run_pipeline():
	...
	with dai.Device(pipeline) as device:
		cur_brightness=800
		depth_queue:dai.DataOutputQueue = device.getOutputQueue(name="depth", maxSize=1, blocking=True)
		rgb_queue:dai.DataOutputQueue = device.getOutputQueue(name="rgb", maxSize=1, blocking=True)
